...
void ObjectMemCpyToGpu(Object *object_host, Object *object_gpu_handle, std::map<void *, void *> &meterial_cpu_to_gpu) {
    ...
    cudaMemcpyFromSymbol(&object_gpu_handle->IntersectionTestPtr, fp_intersection_sphere,
                         sizeof(FuncIntersectionTestPtr));
    cudaMemcpyFromSymbol(&object_gpu_handle->ClosetHitPtr, fp_closet_hit, sizeof(FuncIntersectionTestPtr));
}